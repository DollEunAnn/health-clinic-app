...
const { validate, prescriptionRules } = require('../helpers/validator');
...
const writePrescription = async (req, res) => {
    ...
    try {
        const { passes, errors } = validate(req.body, prescriptionRules);
        if (!passes) {
...
const updatePrescription = async (req, res) => {
    ...
    try {
        ...
        const response = await mongodb
            .getDatabase()
            .collection('prescriptions')
            .replaceOne({ _id: prescriptionId }, prescription);
